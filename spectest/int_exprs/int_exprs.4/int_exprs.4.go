...
func (m *Module) Xi32응2Eno_fold_shr_s_shl(v0 int32) int32 {
	return i32_shl(i32_shr_s(v0, int32(1)), int32(1))
}
func (m *Module) Xi32응2Eno_fold_shr_u_shl(v0 int32) int32 {
	return i32_shl(i32_shr_u(v0, int32(1)), int32(1))
}
func (m *Module) Xi64응2Eno_fold_shr_s_shl(v0 int64) int64 {
	return i64_shl(i64_shr_s(v0, int64(1)), int64(1))
}
func (m *Module) Xi64응2Eno_fold_shr_u_shl(v0 int64) int64 {
