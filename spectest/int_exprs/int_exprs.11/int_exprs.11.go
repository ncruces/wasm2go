...
func (m *Module) Xi32응2Ediv_s_0(v0 int32) int32 {
	t0 := i32_div_s(v0, i32_const(0))
	return t0
}
func (m *Module) Xi32응2Ediv_u_0(v0 int32) int32 {
	t0 := int32(uint32(v0) / uint32(i32_const(0)))
	return t0
}
func (m *Module) Xi64응2Ediv_s_0(v0 int64) int64 {
	t0 := i64_div_s(v0, i64_const(0))
	return t0
}
func (m *Module) Xi64응2Ediv_u_0(v0 int64) int64 {
