...
func (m *Module) Xas_br_value_1sx9dl7() int32 {
	...
	_ = p0
	{
		t1 := int32(binary.LittleEndian.Uint32(m.memory[uint32(i32(0)):]))
		p0 = t1
		goto l0
	}
l0:
...
func (m *Module) Xas_store_address_374rd1() {
	t0 := int32(binary.LittleEndian.Uint32(m.memory[uint32(i32(0)):]))
	binary.LittleEndian.PutUint32(m.memory[uint32(t0):], uint32(i32(7)))
}
func (m *Module) Xas_store_value_1bx4mta() {
	t0 := int32(binary.LittleEndian.Uint32(m.memory[uint32(i32(0)):]))
	binary.LittleEndian.PutUint32(m.memory[uint32(i32(2)):], uint32(t0))
}
func (m *Module) Xas_storeN_address_qez1rh() {
	t0 := int32(int8(m.memory[uint32(i32(0))]))
	m.memory[uint32(t0)] = byte(i32(7))
}
func (m *Module) Xas_storeN_value_7lcb3d() {
	t0 := int32(binary.LittleEndian.Uint32(m.memory[uint32(i32(0)):]))
	binary.LittleEndian.PutUint16(m.memory[uint32(i32(2)):], uint16(t0))
}
func (m *Module) Xas_unary_operand_kr3bi8() int32 {
	t0 := int32(binary.LittleEndian.Uint32(m.memory[uint32(i32(100)):]))
