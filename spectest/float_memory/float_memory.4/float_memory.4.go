...
func (m *Module) Xf32_store_1h39ogx() {
	binary.LittleEndian.PutUint32(m.memory[uint32(i32(0)):], math.Float32bits(math.Float32frombits(0x7fd00001)))
}
func (m *Module) Xi32_store_1hciawc() {
	binary.LittleEndian.PutUint32(m.memory[uint32(i32(0)):], uint32(i32(0x7fd00001)))
}
