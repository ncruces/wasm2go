...
func (m *Module) Xf64_store_193toh6() {
	binary.LittleEndian.PutUint64(m.memory[uint32(i32(0)):], math.Float64bits(math.Float64frombits(0x7ffc000000000001)))
}
func (m *Module) Xi64_store_1pgnj53() {
	binary.LittleEndian.PutUint64(m.memory[uint32(i32(0)):], uint64(i64(0x7ffc000000000001)))
}
